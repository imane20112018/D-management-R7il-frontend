        ...
        <ul class="header-extras d-none d-sm-flex mx-auto mx-md-0 mb-4 mb-md-0">
          <li>
            ...
            <div class="he-text fw-normal text-white-50">
              Appelez-nous :
              <span><a href="tel:+212 619 222 222" class="text-white fw-medium">+212 619 222 222</a></span>
            </div>
          </li>
          <li>
            ...
            <div class="he-text fw-normal text-white-50">
              Écrivez-nous :
              <span><a href="mailto:R7il@R7il.ma" target="_top" class="text-white fw-medium">R7il@R7il.ma</a></span>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="container">
        <div class="header-row justify-content-between flex-row-reverse flex-lg-row">
          ...
          <form class="top-search-form" action="/recherche" method="get">
            <input type="text" name="q" class="form-control" placeholder="Tapez votre recherche..." autocomplete="off">
          </form>
        </div>
      </div>
    </div>
