                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" v-model="name" type="text" value="lucky.jesse" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" v-model="city" type="text" value="New York" />
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
...
function handleProfileUpdate() {
  console.log('Saved profile:', { name: name.value, email: email.value })
  // Here you’d dispatch API calls to update the profile
}
</script>
