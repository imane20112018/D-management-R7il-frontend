  ...
  <main class="main" id="top">
    <div class="container py-4">
      <div class="d-flex align-items-center justify-content-between mb-4">
        <h2 class="mb-0">📌 Abonnements valides</h2>
...
export default {
  ...
  methods: {
    ...
    async fetchValides(page = 1) {
      try {
        const { data } = await api.get("/admin/abonnements/valide", {
        ...
        console.error("Erreur chargement valides :", err.response?.data || err.message);
      }
    },
    async resilier(id) {
      ...
      try {
        ...
        this.fetchValides(this.pagination.current_page);
      } catch (err) {
        console.error("Erreur résiliation :", err.response?.data || err.message);
      }
    },
    changePage(page) {
      if (page > 0 && page <= this.pagination.last_page) {
        this.fetchValides(page);
      }
    },
