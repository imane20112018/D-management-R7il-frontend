...
import AdminAbonnementsExpires from '@/views/admin/AdminAbonnementsExpires.vue'
const routes = [
  ...
  //Admin routes
 {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'abonnements-refuses',
        name: 'AdminAbonnementsRefuses',
        component: AdminAbonnementsRefuses,
      },
      {
        path: 'abonnements-expires',
        name: 'AdminAbonnementsExpires',
        component: AdminAbonnementsExpires,
      },
    ],
}
