          ...
          <ul class="navbar-nav flex-column" id="navbarVerticalNav">
            <li class="nav-item">
              ...
              <div class="nav-item-wrapper">
                <router-link class="nav-link label-1" to="/admin/dashboard" role="button" data-bs-toggle=""
                  aria-expanded="false">
            ...
            <li class="nav-item">
              ...
              <!-- gestion client-->
              <div class="nav-item-wrapper">
                <a class="nav-link dropdown-indicator label-1" href="#nv-client" role="button" data-bs-toggle="collapse"
                  aria-expanded="false" aria-controls="nv-client">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper">
                      <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                    </div>
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-client">
              ...
              <div class="nav-item-wrapper">
                <a class="nav-link dropdown-indicator label-1" href="#nv-transporteur" role="button"
                  data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-transporteur">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper">
                      <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                    </div>
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-transporteur">
                    <li class="collapsed-nav-item-title d-none">Gestion Transporteur</li>
                    <li class="nav-item">
                      <router-link class="nav-link" to="/admin/transporteurs-valides">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Transporteurs Valides</span>
                        </div>
                      </router-link>
                    </li>

                    <li class="nav-item">
                      <router-link class="nav-link" to="/admin/transporteurs-en-attente">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Transporteurs en attente</span>
                        </div>
                      </router-link>
                    </li>

                    <li class="nav-item">
                      <router-link class="nav-link" to="/admin/transporteurs-incomplets">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Transporteurs incomplets</span>
                        </div>
                      </router-link>
                    </li>

                    <li class="nav-item">
                      <router-link class="nav-link" to="/admin/transporteurs-refuses">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Transporteurs refusés</span>
                        </div>
                      </router-link>
                    </li>
              ...
              <!-- gestion reservation-->
              <div class="nav-item-wrapper">
                <a class="nav-link dropdown-indicator label-1" href="#nv-reservation" role="button"
                  data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-reservation">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper">
                      <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                    </div>
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-reservation">
                    <li class="collapsed-nav-item-title d-none">Gestion Reservation</li>

                    <li class="nav-item">
                      <a class="nav-link" href="pages/authentication/simple/sign-in.html">
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Liste des reservations </span>
                        </div>
                      </a>
                    </li>
              ...
              <!-- gestion abonnement-->
              <div class="nav-item-wrapper">
                <a class="nav-link dropdown-indicator label-1" href="#nv-abonnement" role="button"
                  data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-abonnement">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper">
                      <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                    </div>
                    <span class="nav-link-icon"><span data-feather="dollar-sign"></span></span>
                    <span class="nav-link-text">Gestion Abonnement</span>
                  </div>
                </a>
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-abonnement">
                    <li class="collapsed-nav-item-title d-none">Gestion Abonnement</li>
                       <li class="nav-item">
                      <router-link
                        class="nav-link"
                        to="/admin/abonnements-demandes"
                      >
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Demandes d'abonnement</span>
                        </div>
                      </router-link>
                    </li>
                     <li class="nav-item">
                      <router-link
                        class="nav-link"
                        to="/admin/abonnements-valides"s
                      >
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Abonnements Valides</span>
                        </div>
                      </router-link>
                      <li class="nav-item">
                      <router-link
                        class="nav-link"
                        to="/admin/abonnements-refuses"s
                      >
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Abonnements refusés</span>
                        </div>
                      </router-link>
                    </li>
                     <li class="nav-item">
                      <router-link
                        class="nav-link"
                        to="/admin/abonnements-expires"s
                      >
                        <div class="d-flex align-items-center">
                          <span class="nav-link-text">Abonnements expirés</span>
                        </div>
                      </router-link>
                    </li>
                    </li>
              ...
              <!-- gestion utilisateur-->
              <div class="nav-item-wrapper">
                <a class="nav-link dropdown-indicator label-1" href="#nv-utilisateur" role="button"
                  data-bs-toggle="collapse" aria-expanded="false" aria-controls="nv-utilisateur">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper">
                      <span class="fas fa-caret-right dropdown-indicator-icon"></span>
                    </div>
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent" data-bs-parent="#navbarVerticalCollapse" id="nv-utilisateur">
                    <li class="collapsed-nav-item-title d-none">Gestion Utilisateur</li>
      ...
      <div class="collapse navbar-collapse justify-content-between">
        <div class="navbar-logo">
          ...
          <a class="navbar-brand me-1 me-sm-3" href="/">
            <div class="d-flex align-items-center">
              <div class="d-flex align-items-center">
                <img src="/src/assets/DashboardC/assets/img/logos/logo-white.png" alt="R7IL" width="150" />
            ...
            <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
              ...
              <div class="card position-relative border-0">
                ...
                <div class="card-footer p-0 border-top border-translucent">
                  ...
                  <hr />
                  <div class="px-3">
                    <a class="btn btn-phoenix-secondary d-flex flex-center w-100" href="#" @click="logoutAdmin">
...
const reloadTransporteursIncomplets = () => {
  window.location.href = '/admin/transporteurs-incomplets'
}
const reloadTransporteursValides= () => {
  window.location.href = '/admin/transporteurs-valides'
}
const reloadTransporteursEnAttente= () => {
  window.location.href = '/admin/transporteurs-en-attente'
}
const reloadTransporteursRefuses= () => {
  window.location.href = '/admin/transporteurs-refuses'
}
